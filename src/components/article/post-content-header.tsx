...
type TProps = { category: string; title: string; read: number; thumbnail: string; categorySlug: string }

export default function PostContentHeader({ category, categorySlug, title, read, thumbnail }: TProps) {
	return (
		<div>
