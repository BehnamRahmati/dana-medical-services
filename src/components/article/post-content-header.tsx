...
type TProps = { category: string; title: string; readTime: number; thumbnail: string; categorySlug: string }

export default function PostContentHeader({ category, categorySlug, title, readTime, thumbnail }: TProps) {
	return (
		<div>
