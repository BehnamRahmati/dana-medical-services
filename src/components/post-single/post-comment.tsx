...
export default function PostComment() {
	return (
		<div className='bg-accent border border-border p-10 rounded-xl mt-10'>
			<h2 className='text-3xl font-extrabold'>دیدگاه و پرسش</h2>
			<div className='bg-secondary rounded-lg py-5 px-10 mt-10 flex items-center justify-between'>
