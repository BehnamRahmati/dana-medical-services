...
import ArticlesFilters from './sidebar/articles-filters'
export default function ArticlesMainHeader() {
	...
	return (
		<div className='flex flex-col lg:flex-row lg:items-center justify-start gap-2.5 lg:gap-5 pb-5 border-b border-b-border mb-5'>
			<div className='flex items-center justify-start gap-2.5 lg:gap-5'>
				<div>
					<button
						type='button'
					...
					>
						...
						<span className='text-xs inline-block mr-1'>
							({value === 'createdAt_asc' ? 'قدیمی ترین' : 'بروزترین'})
						</span>
						<DocumentFilter
